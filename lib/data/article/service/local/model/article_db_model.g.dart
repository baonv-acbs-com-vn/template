...
void _articleDbModelSerialize(
  ...
  writer.writeLong(offsets[3], object.publishedAt);
...
ArticleDbModel _articleDbModelDeserialize(
  ...
  final object = ArticleDbModel(
    ...
    publishedAt: reader.readLongOrNull(offsets[3]),
...
void _articleDbModelAttach(
    IsarCollection<dynamic> col, Id id, ArticleDbModel object) {
  object.id = id;
}
...
extension ArticleDbModelQueryWhere
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterWhereClause> titleEqualTo(
      String? title) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
...
extension ArticleDbModelQuerySortBy
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> sortByImageUrl() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> sortByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> sortByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleDbModelQuerySortThenBy
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> thenByImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> thenByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<ArticleDbModel, ArticleDbModel, QAfterSortBy> thenByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.desc);
    });
  }
...
extension ArticleDbModelQueryWhereDistinct
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'hashCode');
    });
  }

  QueryBuilder<ArticleDbModel, ArticleDbModel, QDistinct> distinctByImageUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, ArticleDbModel, QDistinct> distinctByUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleDbModelQueryProperty
  ...
  QueryBuilder<ArticleDbModel, String?, QQueryOperations>
      descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hashCode');
    });
  }

  QueryBuilder<ArticleDbModel, String?, QQueryOperations> imageUrlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'imageUrl');
    });
  }

  QueryBuilder<ArticleDbModel, int?, QQueryOperations> publishedAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleDbModel, String?, QQueryOperations> urlProperty() {
    return QueryBuilder.apply(this, (query) {
